...
@Component({
  selector: 'app-dashboard-testeur',
  standalone: true,
  imports: [NavbarDashboardComponent,SidebarComponent],
  templateUrl: './dashboard-testeur.component.html',
  styleUrl: './dashboard-testeur.component.css'
})
export class DashboardTesteurComponent {
  links = [
    {
      name: 'Notifications',
      href: 'notifications',
