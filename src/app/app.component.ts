...
import { DashboardSystemeComponent } from './dashboards/dashboard-systeme/dashboard-systeme/dashboard-systeme.component';
import { ForgotPasswordComponent } from './forgot-password/forgot-password.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,DashbordComponent,DashboardTesteurComponent,DashboardDeveloppeurComponent,LoginComponent,RegisterComponent,DashboardSystemeComponent,ForgotPasswordComponent],
